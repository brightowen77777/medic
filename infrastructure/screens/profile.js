                    ...
                    <View style={styles.semicontainer}>
                        <View style={styles.docProfile}>
                            ...
                            <View style={styles.docDetails}>
                                <View style={styles.docName}>
                                    <Text style={styles.bigName}>Dr. walters Rogers</Text>
                        ...
                        <View style={styles.docExperience}>
                            ...
                            <View style={styles.docBorders}>
                                ...
                                <Text style={styles.docReviews}>16 Years</Text>
                            </View>
                        ...
                        <Text style={styles.docBioWrite}>He was born in America where he grew up until the age of 17, after which he lived in Hamiltan Ontaio. He obtained his Bachelors of Science in Life Sciences at Queen's University in <Text style={{color:'blue'}}>More...</Text></Text>
                        <View>
