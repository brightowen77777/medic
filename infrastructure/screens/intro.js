    ...
    return (
        <SafeAreaView style={styles.areaView}>
            ...
            <View style={styles.brandContainer}>
                ...
                <Text style={styles.brandInfo}> Easier and faster solution for
                 any medical emergency</Text>
            </View>
            <View style={styles.AuthContainer}>
                <Button mode='contained' color={Theme.colors.text.tertiary} style={{paddingVertical:Theme.sizes[3], marginBottom:Theme.sizes[3]}}
                onPress={ () => navigation.navigate('Signup')}>SIGN UP</Button>
               
                <Button mode='outlined' color={Theme.colors.text.tertiary} style={{paddingVertical:Theme.sizes[3]}}>SIGN IN</Button>
            </View>
